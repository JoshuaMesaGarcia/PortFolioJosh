    ...
    var language = {
      ...
      es: {
        coding: "My especialidad es el desarrollo y el diseño de Front-End. Puedo desarrollar con HTML, CSS and JavaScript entre otros." + "<br/>" + "<br/>"+
        ...
        aboutme:"¡Hola! Mi nombre es Joshua y soy un desarrollador web de las Islas Canarias, España, que vive en Alemania." + "<br/>" +
        "Al principio, viví en Mainz dos meses antes del estallido de la pandemia hasta el verano pasado." + "<br/>" +
        "Fue una pena que la pandemia me afectara porque la ciudad tiene mucho que ofrecer a la gente que vive junto al hermoso Rhein. Después me trasladé a Berlín, donde vivo actualmente." + "<br/>" +
        "Desde el primer momento, Berlín me atrajo por la sociedad multicultural y la mezcla de placer y trabajo. Creo que he encontrado el lugar adecuado para estar los próximos años" + "<br/>" + "<br/>" +
      ...
      deu: {
        ...
        "Ich habe einige Frontend-Herausforderungen von FronEndMentor.io abgeschlossen." + "<br/>" + "<br/>" +
        "Ich habe auch einige Projekte in anderen Sprachen gemacht, komm und schau sie dir an!",

        hobby: "Wenn ich nicht gerade am Computer programmiere oder Videospiele spiele, verbringe ich meine Zeit in meinem kleinen Studio, spiele Schlagzeug." + "<br/>" + "<br/>"  +
        "Während der Pandemie habe ich die Zeit, die ich zu Hause war, genutzt, um ein Instrument zu lernen, das ich schon immer geliebt habe. Meine Nachbarn diese Entscheidung zunächst nicht gut fanden." + "<br/>" + "<br/>" +
        "In der Freizeit baue ich einige historische Modelle des Ersten und Zweiten Weltkriegs, von Flugzeugen bis zu Schlachtschiffen"  + "<br/>" +
        "Wenn Sie einige Videos und Fotos von meinen Hobbys sehen wollen, klicken Sie hier!",

        aboutme:"Hallo zusammen! Ich bin Joshua, ein Webentwickler von den Kanarischen Inseln, Spanien, der in Deutschland lebt." + "<br/>" + "<br/>" +
        "Zunächst lebte ich zwei Monate vor dem Ausbruch der Pandemie bis zum letzten Sommer in Mainz." + "<br/>" +
        "Es war schade, dass mich die Pandemie traf, denn die Stadt hat für die Menschen, die am schönen Rhein leben, viel zu bieten. Danach bin ich nach Berlin gezogen, wo ich jetzt lebe." + "<br/>" +
        "Vom ersten Moment an hat mich Berlin mit seiner multikulturellen Gesellschaft und der Mischung aus Vergnügen und Arbeit angezogen. Ich denke, ich habe den richtigen Ort für die nächsten Jahre gefunden" + "<br/>" + "<br/>" +
        "Ich habe auch in Irland gelebt, ein Ort, der immer meine zweite Heimat sein wird. Die Mystik von Connemara und die einladende Atmosphäre von Galway werden immer in meinem Herzen sein. " + "<br/>" 
      }
    };
